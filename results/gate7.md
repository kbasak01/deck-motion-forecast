...
| 3 | README states measured numbers with methodology and no generic multipliers | PASS | 37 millisecond figures quoted, 0 not in the committed latency tables; 9 multipliers quoted, 0 not reproducible as a same-model same-batch p50 ratio (pool of 665 ratios, which would accept 65 percent of plausible multipliers -- the ms check is the stricter half); methodology tokens missing: none. |
