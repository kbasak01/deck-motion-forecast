function [eta_WF, nu_WF, nudot_WF, waveElevation] = waveMotionRAO_seeded(...
    t, S_M, Amp, Omega, mu, vessel, U, psi, beta_wave, numFreqIntervals, phasesIn)
...
if isempty(RAO_im_values_interpolated)
    ...
    numDirections = length(mu);   % PATCH 3: rng(12345) draw removed, see mss/PATCHES.md
